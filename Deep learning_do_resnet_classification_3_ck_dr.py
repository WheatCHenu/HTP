...
CK_0 = WheatDataset(root_dir='data/CK_/CK_0', transform=train_transformer)
CK_1 = WheatDataset(root_dir='data/CK_/CK_1', transform=train_transformer)
CK_2 = WheatDataset(root_dir='data/CK_/CK_2', transform=train_transformer)

DR_0 = WheatDataset(root_dir='data/DR_/DR_0', transform=train_transformer)
DR_1 = WheatDataset(root_dir='data/DR_/DR_1', transform=train_transformer)
DR_2 = WheatDataset(root_dir='data/DR_/DR_2', transform=train_transformer)


dataset_ck = ConcatDataset([CK_0, CK_1, CK_2])
dataset_dr = ConcatDataset([DR_0, DR_1, DR_2])
...
kf_ck = kfold_split_3(CK_0, CK_1, CK_2, 10)
kf_dr = kfold_split_3(DR_0, DR_1, DR_2, 10)
test_acc = []
dataset = ConcatDataset([dataset_ck, dataset_dr])
print(len(dataset))
ck_len = len(dataset_ck)
